	...
	<div class="limiter">
		<div class="container-table100">
			<div class="wrap-table100">
				<div class="table100">
<!-- table data -->
				<h1>KUMPULAN SINONIM</h1>
					<table id="table_id">
				<thead>
							<tr class="table100-head">
								<th class="column1">ID</th>
								<th class="column2">Sinonim</th>
							</tr>
				</thead>
				<?php
        								include "koneksi.php";
       									 $sql="SELECT * from sinonim order by sinonim";
			...
			<button type="button" class="btn btn-dark" onclick="window.location.href='#'">Sinonim</button>
