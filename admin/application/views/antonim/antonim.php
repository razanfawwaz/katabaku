<div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Antonim Edit Page</h1>
          <!DOCTYPE html>
<html>
<head>
...
<table class="table table-bordered table-hover" id="table_id">
        ...
        <?php
        include "../koneksi.php";
        $sql="select * from antonim order by id_antonim desc";
        ...
        while ($data = mysqli_fetch_array($hasil)) {
            ...
            <tr>
                <td><?php echo $no;?></td>
                <td><?php echo $data["antonim"]; ?></td>
                <td>
                    <a href="antonimedit?id_antonim=<?php echo htmlspecialchars($data['id_antonim']); ?>" class="btn btn-warning" role="button">Update</a>
                    <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?id_antonim=<?php echo $data['id_antonim']; ?>" class="btn btn-danger" role="button">Delete</a>
                </td>
            </tr>
            </tbody>
            <?php
    ...
    <a href="antonim-create.php" class="btn btn-primary" role="button">Tambah Data</a>
